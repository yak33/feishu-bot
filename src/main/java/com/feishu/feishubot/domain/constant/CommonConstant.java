package com.feishu.feishubot.domain.constant;
...
public interface CommonConstant {
     ...
     * 操作日志所属模块： 产品库
     */
    public static final int LOG_TYPE_10 = 10;
     ...
     * 登录用户租户信息Redis KEY
     */
    public static final String PREFIX_TENANT_TOKEN_INFO = "prefix_tenant_info_token_";
    public static final String PREFIX_TENANT_TOKEN_OBJ = "prefix_tenant_info_token_obj_";
    public static final String PREFIX_TOKEN_API_OBJ = "prefix_token_api_obj_";

    public static final String REDIS_BUSINESS_HANDLER = "businessHandler";
//    /** Token缓存时间：3600秒即一小时 */
//    public static final int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    */
    ...
    /**通告对象类型（USER:指定用户，TENANT:租户内的用户，ALL:全体用户）*/
    public static final String MSG_TYPE_UESR  = "USER";
    public static final String MSG_TYPE_TENANT  = "TENANT";
    ...
    /** 合同 表 username 唯一键索引 */
    public static final String SQL_INDEX_UNIQ_CONTRACT = "uniq_contract";
